...
#define ledpin_UNO    13                  // numero do pino onde o LED Verde supervisionamento do funcionamento do codigo
...
void Config_mcu()
{
                               ...
                               pinMode (ledpin_UNO, OUTPUT);                // configura o pino do LED 13 como saida
                               digitalWrite(ledpin_UNO,LOW);  
